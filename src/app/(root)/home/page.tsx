  ...
  return (
    <main className="w-full h-screen flex justify-center ">
      <div className="w-full text-center flex flex-col justify-center items-center">
        ...
        <button className="bg-blueButton text-[1.6rem] text-white font-semibold w-[80%] h-[4.4rem] rounded-[0.8rem] mt-[2.6rem] hover:cursor-pointer hover:translate-y-[-1.0rem] transition-all">Gerar Dieta</button>
